...
//     return (
//         <>
//             <div className="bg-[#222d3f] rounded-lg p-4 mb-4 shadow">
//                 <h2 className=" py-1.5 text-lg text-gray-300 font-semibold">{team1Score}</h2>
//                 <h2 className=" py-1.5 text-lg text-gray-300 font-semibold">{team2Score}</h2>
...
//                 <h2 className="text-lg font-semibold text-gray-300">{team1Score}</h2>
//                 <h2 className="text-lg font-semibold text-gray-300">{team2Score}</h2>
//                 <div className='flex justify-between items-center mt-3'>
//                     <p className="text-red-500 font-medium">{miniScore?.status}</p>
//                     <button onClick={refreshHandler} className="bg-blue-600 hover:bg-blue-500 text-white px-4 py-2 rounded transition">⟳ Refresh</button>
//                 </div>
//                 <RecentOvers recentOvsStats={miniScore?.recentOvsStats} />
//             </div>

//             <div className="p-4 bg-gray-800 rounded-lg">
//                 <h3 className="text-yellow-400 text-lg font-semibold mb-3">Batting</h3>
...
//             <div className="p-4 bg-gray-800 rounded-lg">
//                 <h3 className="text-yellow-400 text-lg font-semibold mb-3">Bowling</h3>
//                 <div className="flex justify-between border-b border-gray-700 pb-2">
//                     <p>Bowler</p>
//                     <div className="flex space-x-4">
...
//             <div className="p-4 bg-gray-800 rounded-lg">
//                 <h3 className="text-yellow-400 text-lg font-semibold mb-3">Key Stats</h3>
//                 <p>Partnership: {miniScore?.partnerShip?.runs} ({miniScore?.partnerShip?.balls})</p>
//                 {miniScore?.lastWicket && <p>Last Wicket: {miniScore?.lastWicket}</p>}
//                 <p>Current Run Rate: {miniScore?.currentRunRate}</p>
//                 {miniScore?.latestPerformance && <p>Last 10 Overs: {miniScore?.latestPerformance[0]?.runs} runs & {miniScore?.latestPerformance[0]?.wkts} wkts</p>}
